...
function buildAssistantBody({ restaurantName, publicUrl, webhookSecret, enabledRoles }) {
  ...
  const roleLabel = orders ? 'KI-Reservierungsassistent' : 'digitale Mitarbeiter';
  ...
  return {
    ...
    firstMessage: `Grüß Gott, hier ist Kiwo, der ${roleLabel} von {{restaurant_name}}. Zur Qualitätssicherung wird dieses Gespräch aufgezeichnet und automatisiert verarbeitet. Wie kann ich Ihnen helfen?`,
